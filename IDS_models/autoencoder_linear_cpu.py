...
experiment = neptune.create_experiment('ae-17-linear-cpu', tags=["autoencoder", "cicids2017", "binary", "linear", "CPU"])
...
#     params["n_layers"] = trial.suggest_int('encoder_layers', 1, 5)
    params["n_layers"] = trial.suggest_int('encoder_layers', 3, 6)
...
study.optimize(objective, timeout=60*60*5, callbacks=[NeptuneCallback()], catch=(StorageInternalError,), n_jobs=-1)
