...
experiment = neptune.create_experiment('ae-17-sigmoid-cpu-tied', tags=["autoencoder", "cicids2017", "binary", "sigmoid", "CPU", "Tied"])
study_name = experiment.id
save_dir = f'results/binary/autoencoder/{study_name}'
study_storage = 'results/binary/autoencoder_sigmoid_tied.db'
