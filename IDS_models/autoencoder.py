...
experiment = neptune.create_experiment('ae-17-sigmoid-gpu', tags=["autoencoder", "cicids2017", "binary", "sigmoid", "GPU"])
...
study.optimize(objective, timeout=60*60*8, callbacks=[NeptuneCallback()], catch=(StorageInternalError,)) #, n_jobs=-1)
